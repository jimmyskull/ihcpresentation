...
\title[Doutor Pecúlio]{Doutor Pecúlio}
...
\begin{frame}
    ...
    \begin{block}{\emph{Intelligent Personal Assistant} (IPA)}
        ...
        acessando APIs públicas.
    \end{block}
    
    \uncover<2->{
    \begin{block}{\emph{Standalone Personal Assistant} (SPA)}
        Agente projetado para receber tarefas do usuário (ex:
        por comando de voz) e delegar aos agentes inteligentes 
        especializados (IPAs).
    \end{block}
